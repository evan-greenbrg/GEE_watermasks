#!/bin/bash
river='Snake'
poly="/home/greenberg/ExtraSpace/PhD/Projects/Dams/DataArchive/RiverDatabase/Snake/$river.gpkg"
...
dtype="int"    # int, float 
water_level="3"
start="04-01"   # Month-Day format with leading 0s
end="10-31"     # Month-Day format with leading 0s
start_year="1985"   
end_year="2022"     
out="/home/greenberg/ExtraSpace/PhD/Projects/Dams/DataArchive/RiverDatabase/Snake"
