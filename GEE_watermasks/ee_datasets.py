...
def getLandsatCollection():
    ...
    #'QA_PIXEL'
    # 'QA'
    bn9 = ['SR_B1', 'SR_B2', 'SR_B3', 'SR_B4', 'SR_B6', 'pixel_qa', 'SR_B5', 'SR_B7']
    bn8 = ['SR_B1', 'SR_B2', 'SR_B3', 'SR_B4', 'SR_B6', 'pixel_qa', 'SR_B5', 'SR_B7']
    bn7 = ['SR_B1', 'SR_B1', 'SR_B2', 'SR_B3', 'SR_B5', 'pixel_qa', 'SR_B4', 'SR_B7']
    bn5 = ['SR_B1', 'SR_B1', 'SR_B2', 'SR_B3', 'SR_B5', 'pixel_qa', 'SR_B4', 'SR_B7']
    bns = ['uBlue', 'Blue', 'Green', 'Red', 'Swir1', 'QA', 'Nir', 'Swir2']
